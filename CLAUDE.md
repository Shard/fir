...
1. **Always test with real screenshots**: Recognition quality is critical
2. **Consider multiple icon mods**: Different player communities use different mods
3. **Performance matters**: Models run in browser, keep them optimized
